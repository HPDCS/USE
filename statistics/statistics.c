...
static void _print_statistics(struct stats_t *stats) {
	...
	printf("Events executed and committed per LP............: %12.2f\n",
		stats->events_exec_and_committed_lp);
	#endif
