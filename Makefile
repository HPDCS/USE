...
CFLAGS:=$(CFLAGS) -DIPI_STATISTICS=$(IPI_STATISTICS)
else
CFLAGS:=$(CFLAGS) -DIPI_STATISTICS=0
endif

ifdef COLLISION_LIST
CFLAGS:=$(CFLAGS) -DCOLLISION_LIST=$(COLLISION_LIST)
else
CFLAGS:=$(CFLAGS) -DCOLLISION_LIST=0
endif

ifdef CHECK_ROLLBACK_AFTER_EXECUTION
CFLAGS:=$(CFLAGS) -DCHECK_ROLLBACK_AFTER_EXECUTION=$(CHECK_ROLLBACK_AFTER_EXECUTION)
else
CFLAGS:=$(CFLAGS) -DCHECK_ROLLBACK_AFTER_EXECUTION=0
endif
