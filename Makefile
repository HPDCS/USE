...
ifdef IPI_SUPPORT_FUTURE
CFLAGS:= $(CFLAGS) -DIPI_SUPPORT_FUTURE=$(IPI_SUPPORT_FUTURE)
else
CFLAGS:= $(CFLAGS) -DIPI_SUPPORT_FUTURE=0
endif

ifdef IPI_SUPPORT_PAST
CFLAGS:= $(CFLAGS) -DIPI_SUPPORT_PAST=$(IPI_SUPPORT_PAST)
else
CFLAGS:= $(CFLAGS) -DIPI_SUPPORT_PAST=0
endif
