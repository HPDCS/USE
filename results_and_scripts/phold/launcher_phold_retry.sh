							...
							do
								...
								do
									...
									do
										...
										do
											FILE_ORI="${PATH_RESULTS}/${test}-ori-$threads-$lp-maxlp-$max_lp-look-$lookahead-ck_per-$ck-fan-$fan_out-loop-$loop_count-$run"; touch ${FILE_ORI}
											FILE_IPI="${PATH_RESULTS}/${test}-ipi-$threads-$lp-maxlp-$max_lp-look-$lookahead-ck_per-$ck-fan-$fan_out-loop-$loop_count-$run"; touch ${FILE_IPI}
