										...
										do
											...
											do
												...
												do
													...
													do
														FILE_ORI="${PATH_RESULTS}/${test}-ori-$threads-$lp-maxlp-$max_lp-look-$lookahead-ck_per-$ck-ta-$ta-ta_duration-$ta_duration-chan_per_cell-$channels_per_cell-ta_change-$ta_change-$run"; touch ${FILE_ORI}
														FILE_IPI="${PATH_RESULTS}/${test}-ipi-$threads-$lp-maxlp-$max_lp-look-$lookahead-ck_per-$ck-ta-$ta-ta_duration-$ta_duration-chan_per_cell-$channels_per_cell-ta_change-$ta_change-$run"; touch ${FILE_IPI}
