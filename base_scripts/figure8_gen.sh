...
#python plot-scripts/figure9_plot.py    results/pcs-hs-0.48/ pcs
#python plot-scripts/figure9_plot.py    results/pcs-hs-0.24/ pcs
#python plot-scripts/figure9_plot.py    results/pcs-hs-0.12/ pcs
